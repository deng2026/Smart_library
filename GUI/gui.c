...
//此处必须在外部申明ascii_1206和ascii_1608;
//#include "font.h" 
...
void gui_init(void)
{
	...
	gui_phy.draw_point=LCD_DrawFRONT_COLOR;//快速画点
	gui_phy.fill=LCD_Fill;		 
	gui_phy.colorfill=LCD_Color_Fill;		 
	gui_phy.back_color=BACK_COLOR;		 
	gui_phy.lcdwidth=tftlcd_data.width;
	gui_phy.lcdheight=tftlcd_data.height; 
